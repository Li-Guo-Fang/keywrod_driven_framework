...
from Utile.Log import info
from Utile.TakePic import take_pic
from Conf.ProjVar import *
from Action.Action import  *
from Utile.DataAndTime import *
...
def execute_test_case():
    ...
    wb = ExcelUtile(test_data_file_path)
