...
if __name__ == "__main__":
    ini_file_path = r"D:\keywrod_driven_framework\Conf\PageElementLocator.ini"
    print(read_ini_file_all_sections(ini_file_path))
    print(read_ini_file_section_all_options(ini_file_path,'126mail_homePage'))
    print(read_ini_file_option(ini_file_path,'126mail_homePage','addcontacts.PersonEmail'))
